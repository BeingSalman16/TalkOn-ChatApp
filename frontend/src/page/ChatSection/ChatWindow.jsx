            ...
            {msgs
              ...
              .map((msg) => (
                <MessageBubble
                  ...
                  //  Pass onImageClick to open modal
                  onImageClick={(src) => setImageModal(src)}
                />
              ))}
          </React.Fragment>
        ))}
...
{imageModal && (
  <div
    ...
    onClick={() => setImageModal(null)} //  Background click se close
  >
    {/* Close Button */}
    <button
      onClick={() => setImageModal(null)}
      className="absolute top-4 right-4 text-white text-3xl bg-black/40 rounded-full px-3 py-1 hover:bg-black/60 transition"
    >
      &times;
    </button>
    ...
    <img
      ...
      onClick={(e) => e.stopPropagation()} // Click on image won't close
    />

    {/* Extra Close Option at Bottom */}
    <button
      onClick={() => setImageModal(null)}
      className="absolute bottom-6 px-6 py-2 bg-white text-black rounded-full shadow-md hover:bg-gray-200 transition"
    >
      Close
    </button>
  </div>
      ...
      >
        ...
        <input
          ...
          className={`flex-grow px-4 py-2 border rounded-full focus:outline-none focus:ring-2 ${
            theme === "dark"
              ? "bg-gray-700 text-white border-gray-600 focus:ring-gray-700"
              : "bg-white text-black border-gray-300 focus:ring-gray-200"
          }`}
        />
